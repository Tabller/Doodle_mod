...
{
    internal class DoodleSurfaceBackgroundStyle : ModSurfaceBackgroundStyle
    {
        ...
        public override int ChooseMiddleTexture()
        {
            ...
            switch (SurfaceFrame)
            {
                ...
                case 3:
                    return BackgroundTextureLoader.GetBackgroundSlot("DoodleMod/Assets/Textures/Backgrounds/ExampleBiomeSurfaceMid3"); // You can use the full path version of GetBackgroundSlot too
                default:
                    return -1;
            }
        }
